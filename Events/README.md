...
The SingletonClass we inherited from is a class that I made that enables us to use the singleton pattern. For more info and to see the code, [Click here](../Design-Patterns/Singletone-Pattern/).
